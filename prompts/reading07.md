---
layout: page
title: 'Prompt for "Undefined Behavior: What Happened to My Code?"'
---
...
1. Undefined behavior is sometimes interpreted by programmers to mean that if a program performs any operation left undefined by a language specification, it is legal for the compiler to generate corresponding code that does _anything_.  Do you think that argument is correct?  Why or why not?
1. This paper enumerates a number of problems, and although a few potential fixes are mentioned at the end, it is a little light on details.  What do _you_ think is the most promising fix?  Why?
...
<em>Please</em> be sure to name your generated PDF <code class="language-plaintext highlighter-rouge">reading07.pdf</code>.
